...
int main()
{
    ...
    long long int ppcm=(s1.size()*s2.size())/pgcd(s1.size(),s2.size());
    for(long long int c=0;c<ppcm;c++)
        if((s1[c%s1.size()]=='R'&&s2[c%s2.size()]=='S')||(s1[c%s1.size()]=='S'&&s2[c%s2.size()]=='P')||(s1[c%s1.size()]=='P'&&s2[c%s2.size()]=='R'))
            p2++;
        else if((s2[c%s2.size()]=='R'&&s1[c%s1.size()]=='S')||(s2[c%s2.size()]=='S'&&s1[c%s1.size()]=='P')||(s2[c%s2.size()]=='P'&&s1[c%s1.size()]=='R'))
            p1++;
    p1*=n/ppcm;
    p2*=n/ppcm;
    for(long long int c=0;c<n%ppcm;c++)
        if((s1[c%s1.size()]=='R'&&s2[c%s2.size()]=='S')||(s1[c%s1.size()]=='S'&&s2[c%s2.size()]=='P')||(s1[c%s1.size()]=='P'&&s2[c%s2.size()]=='R'))
            p2++;
        else if((s2[c%s2.size()]=='R'&&s1[c%s1.size()]=='S')||(s2[c%s2.size()]=='S'&&s1[c%s1.size()]=='P')||(s2[c%s2.size()]=='P'&&s1[c%s1.size()]=='R'))
            p1++;
